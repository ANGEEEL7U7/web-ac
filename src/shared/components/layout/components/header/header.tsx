...
export default function Header() {
    ...
    return <nav className="header" data-scrolling={scrollActivo}>
        {/* contenido para pantallas grandes */}
        <div className="w-full pr-3 pl-4 whitespace-nowrap lg:flex hidden">
            <div className="flex gap-2 flex-1">
                <button className="px-4 rounded-full bg-indigo-300 text-black">Contenido E</button>
                <button className="px-4 rounded-full bg-indigo-300 text-black">Contenido Ch</button>
                <button className="px-4 rounded-full bg-indigo-300 text-black">Contenido Ed</button>
            </div>
