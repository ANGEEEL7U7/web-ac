...
export default function Header() {
    ...
    return <header className="header" data-scrolling={scrollActivo}>
        <nav>
            ...
            <div className="whitespace-nowrap lg:flex hidden gap-2">
                <div className="flex gap-2 dark:text-white text-black bg-neutral-700">
                    <button className="">Contenido E</button>
                    <button className="">Contenido Ch</button>
                    <button className="">Contenido Ed</button>
                </div>
